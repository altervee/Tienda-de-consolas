...
document.getElementById("texto").innerHTML +=  "Bienvenide " + params2[0] + " " + params2[1] + " " + params2[2];
...
if (calcularEdad(params2[3]) >= 18){// se inserta la fecha de usu en la funcion anterior
    alert("Bienvenide " + params2[0] + " " + params2[1] + " " + params2[2]);
}else{
    alert("Lo sentimos pero usted debe ser mayor de edad");
